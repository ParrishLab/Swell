...
from swell.shared.persistence.schema import (
    ...
    LEGACY_HOST_PERSISTENCE_OWNERS,
    MANIFEST_FILENAME,
...
from swell.shared.persistence.serialization import (
...
from swell.shared.persistence.zip_io import read_json, read_npz, touch_extract_dir_marker, write_json, write_npz
    ...
    def load(self, source_path: str | Path) -> UnifiedProjectState:
        ...
        with zipfile.ZipFile(src, "r") as zf:
            ...
            if not isinstance(manifest, dict) or not manifest:
                raise ValueError("Not a host Swell project container")
            try:
            ...
            supported_owners = (HOST_PERSISTENCE_OWNER, *LEGACY_HOST_PERSISTENCE_OWNERS)
            if owner is not None and str(owner) not in supported_owners:
