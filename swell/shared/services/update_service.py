    ...
    def _load(self) -> None:
        ...
        for candidate in self._dll_candidates:
            ...
            try:
                ...
                dll.win_sparkle_set_app_details("Clay Dunford", "Swell", self._current_version)
    ...
    def _build_framework(self, *, platform_name: str, appcast_url: str) -> _FrameworkUpdater:
        ...
        if platform_name == "windows":
            dll_candidates = [
                ...
                runtime_root / "swell" / "resources" / "updater" / "windows" / "WinSparkle.dll",
                runtime_root / "_internal" / "swell" / "resources" / "updater" / "windows" / "WinSparkle.dll",
            ]
        ...
        bundle_candidates = [
            ...
            runtime_root / "swell" / "resources" / "updater" / "macos" / "Sparkle.framework",
            bundle_resources / "updater" / "macos" / "Sparkle.framework",
            bundle_resources / "swell" / "resources" / "updater" / "macos" / "Sparkle.framework",
        ]
