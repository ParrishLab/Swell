...
from swell.shared.model_copy import MENU_MANAGE_MODELS
...
def build_shared_menu(root, app, *, mode: str, host_mode: bool = False) -> tk.Menu:
    ...
    if mode == "analysis":
        file_items = [
            ("Save Swell Project", ("save_project", "_save_project", "save_session")),
            ("Save Swell Project As...", ("save_project_as", "_save_project_as")),
            (None, None),
        ...
        file_items = [
            ...
            ("Open Swell Project...", ("open_project", "_open_project_dialog", "open_session")),
            ("Save Swell Project", ("save_project", "_save_project", "save_session")),
            ("Save Swell Project As...", ("save_project_as", "_save_project_as")),
            (None, None),
