...
from swell.analysis.core.project_fingerprint import fingerprints_match
...
def save_project_to_path(
    ...
    *,
    ...
    raise RuntimeError(
        ...
        "Use the Swell main window for project lifecycle actions."
    )
...
def apply_loaded_project_plan(app, plan: ProjectLoadPlan) -> None:
    ...
    app.active_event_id = str(plan.ui_state.get("active_event_id", "event_001"))
