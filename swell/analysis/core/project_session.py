...
class ProjectSessionService:
    ...
    def load_event_into_workspace(self, *, event_id: str, event_records: dict[str, EventRecord], seg_state: SegmentationState) -> None:
        ...
        # Thresholds are not persisted in the project file, so masks restored
        # from disk start with an unknown threshold and will not be marked
        # stale until they are regenerated by a run.
        seg_state.mask_thresholds.clear()
