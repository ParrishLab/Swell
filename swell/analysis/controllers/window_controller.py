...
class AnalysisWindowController:
    ...
    def compute_metrics_preview(self) -> None:
        ...
        import numpy as np
        from swell.analysis.core.metrics import compute_frame_metrics, extract_primary_boundary
    ...
    def save_current_masks(self) -> None:
        ...
        if self.event_has_saved_masks_in_project():
            overwrite = messagebox.askyesno(
                ...
                "Masks already exist for this event. Saving will overwrite the stored masks in this project.\n\nContinue?",
                parent=self._dialog_parent(),
            )
            if not overwrite:
