...
APP_NAME="${APP_NAME:-SDApp Dev}"
APP_BUNDLE="${APP_BUNDLE:-$REPO_ROOT/build/dev-macos/$APP_NAME.app}"
CONTENTS_DIR="$APP_BUNDLE/Contents"
MACOS_DIR="$CONTENTS_DIR/MacOS"
RESOURCES_DIR="$CONTENTS_DIR/Resources"
LSREGISTER="/System/Library/Frameworks/CoreServices.framework/Frameworks/LaunchServices.framework/Support/lsregister"
APP_ICON_SRC="$REPO_ROOT/sdapp/resources/assets/app_icon.icns"
DOC_ICON_SRC="$REPO_ROOT/sdapp/resources/assets/sdproj_doc_icon.icns"
LAUNCH_SCRIPT="$REPO_ROOT/run_mac.command"
LAUNCHER_PATH="$MACOS_DIR/SDAppDev"
...
cp "$DOC_ICON_SRC" "$RESOURCES_DIR/sdproj_doc_icon.icns"
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>sdproj_doc_icon.icns</string>
      <key>CFBundleTypeName</key>
      <string>SDApp Project</string>
  ...
  <string>SDAppDev</string>
  <key>CFBundleIconFile</key>
  <string>app_icon.icns</string>
  <key>CFBundleIdentifier</key>
  <string>com.sdapp.desktop.dev</string>
...
echo "Double-clicking .sdproj should now open through the source checkout launcher."
