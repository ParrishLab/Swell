...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle">
  <channel>
    ...
    <item>
      ...
      <sparkle:releaseNotesLink>https://github.com/ParrishLab/Swell/releases/tag/v0.1.4</sparkle:releaseNotesLink>
      <enclosure
        url="https://github.com/ParrishLab/Swell/releases/download/v0.1.4/Swell-Setup-0.1.4.exe"
        length="123"
