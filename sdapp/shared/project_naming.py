...
def derive_sdproj_filename(
    *,
    default_base: str,
    input_dir: str | Path | None = None,
    source_paths: Iterable[str | Path] | None = None,
) -> str:
    return f"{derive_input_folder_name(input_dir=input_dir, source_paths=source_paths) or str(default_base)}.sdproj"
