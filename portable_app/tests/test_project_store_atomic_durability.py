...
from app.core import project_store as project_store_mod
from app.core.project_store import ProjectStore, _fsync_parent_directory
...
class ProjectStoreAtomicDurabilityTests(unittest.TestCase):
    ...
    def test_parent_fsync_best_effort_on_open_error(self):
        with patch("app.core.project_store.os.open", side_effect=OSError("not supported")):
