...
class UiHelpersTests(unittest.TestCase):
    def test_apply_theme_configures_style(self):
        ...
        with patch("app.ui.theme.ttk.Style", return_value=fake):
    ...
    def test_build_preview_overlay_binds_drag_handlers(self):
        with patch("app.ui.widgets.ttk.Frame", _FakeFrame), patch("app.ui.widgets.tk.Canvas", _FakeCanvas), patch(
            "app.ui.widgets.tk.Label", _FakeLabel
        ):
